...
class population
{
    public:
        ...
        population(coordinates &map, int seed[4]);
        ...
        */
        ...
        crom get_best();
        void receive_migration(crom sol);

    private:

        int _pop_size=10, _evolution_steps=100, _ncities, _Nmigr=10;
        ...
        */
        ...
        void substitute_best(crom sol);
        
        void substitute_worst(crom sol);
